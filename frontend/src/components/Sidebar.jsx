...
import {
  Sidebar as ShadcnSidebar, SidebarContent, SidebarHeader, SidebarMenu,
...
export default function Sidebar() {
  ...
  useEffect(() => {
    axios.get(`${API_URL}/settings/system`, { withCredentials: true })
      .then(r => { if (r.data.success) setSystemName(r.data.data.system_name || 'OPS Management'); })
      .catch(() => {});
  }, []);
